...
namespace DataAccess.Concrete.InMemory
{
    public class InMemoryProductDal : IProductDal
    {
        ...
        public void Delete(Product product)
        {
            ...
            //LINQ ile listede dolaşma işlemi
            //SingleOrDefault tek bir sonuç vereceğinden genellikle Id gibi primary key'lerde kullanılır.
            //İki değer verirse hata verir.
            Product productToDelete = _products.SingleOrDefault(p => p.ProductId == product.ProductId);

            _products.Remove(productToDelete);
            //doğrudan remove metotunu kullansaydık referans değişeceği için silinmeyecekti.
        }
        ...
        {
            //yeni bir liste haline getirip o listeyi döndürür.
        ...
        public void Update(Product product)
        {
            ...
            //LINQ ile listede dolaşma işlemi
            //Gönderilen ürün id'sine listede sahip olan ürünü bul.
